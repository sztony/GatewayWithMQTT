...
#define ADDRESS "34.210.69.19"
#define CLIENTID    "Parking"
#define TOPIC       "lora/parking"
#define PAYLOAD     "Raspberry TEST"
#define QOS         1
...
static char platform[24]    = "AI LoRa Internet";  /* platform definition */
static char email[40]       = "andrey.d@bigdatahush.com";                        /* used for contact email */
static char description[64] = "LoRa_Gateway";                        /* used for free form description */

// define servers
// TODO: use host names and dns
#define SERVER1 "34.210.69.19"   
    ...
    /* //strcpy(message, "hello messagge");
        ...
        byte value = readRegister(REG_PKT_SNR_VALUE);
         ...
         //  buff_up[buff_index] = '\0';
            ...
            //send the messages use socket
           // sendudp(buff_up, buff_index);


            //send the messages use mqtt
            mqtt_publisher((char *)(buff_up + 12));
